...
const it: Messages = {
	...
	tl: {
		...
		qrdNote: 'La scansione avviene interamente nel browser — né l’immagine né il contenuto del codice vengono caricati.',
	...
	tools: {
		...
		'qr-code-decoder': {
			...
			description: 'Leggi i codici QR dalle immagini — URL, WiFi e testo, tutto offline'
		},
		'json-to-yaml': {
