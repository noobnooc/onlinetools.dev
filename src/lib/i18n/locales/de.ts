...
const de: Messages = {
	...
	tl: {
		...
		qrdNote: 'Das Scannen findet vollständig in deinem Browser statt — weder das Bild noch der Inhalt des Codes werden hochgeladen.',
	...
	tools: {
		...
		'qr-code-decoder': {
			...
			description: 'QR-Codes aus Bildern auslesen — URLs, WLAN und Text, komplett offline'
		},
		'json-to-yaml': {
