...
const de: Messages = {
	...
	ui: {
		...
		// About / Why page
		about: 'Über',
		aboutTitle: 'Warum onlinetools.dev — lokal zuerst, kein Tracking, überprüfbar | onlinetools.dev',
		aboutMetaDescription:
			'Warum es onlinetools.dev gibt: Jedes Werkzeug läuft in deinem Browser, nichts, was du einfügst, wird hochgeladen, keine Werbung, keine Tracker, kein Login — und eine Live-Anzeige lässt dich das selbst überprüfen.',
		aboutEyebrow: 'warum es das gibt · Vertrauen',
		aboutVerifyHeading: 'Glaub mir nicht einfach',
		aboutVerifyHint:
			'Tippe oder füge unten irgendetwas ein. Der Zähler bleibt bei null — jeder Tastendruck wird hier auf deinem Rechner verarbeitet.',
		aboutRequestsLabel: 'Netzwerkanfragen seit dem Öffnen dieser Seite',
		aboutRequestsNote:
			'Das Einzige, was diese Zahl bewegen kann, ist das Öffnen eines anderen Werkzeugs, das eigenen Code von derselben Domain lädt. Was du einfügst, niemals.',
		aboutVerifyPlaceholder: 'Tippe oder füge etwas ein — nichts verlässt deinen Browser…',
		aboutOfflineReady: 'Offline-bereit',
		aboutOfflineCaching: 'Wird zwischengespeichert…',
		aboutDevtools:
			'Du willst einen härteren Beweis? Öffne die Entwicklertools deines Browsers, wechsle zum Tab Network (Netzwerk) und füge etwas ein. Du wirst sehen: Es passiert nichts.',
		aboutViewSource: 'Quellcode ansehen',
		...
		// Paste hero (homepage)
		pasteHeroHeading: 'Alles einfügen – sofort das passende Tool erhalten',
		pasteHeroPlaceholder: 'JWT, JSON, Unix-Zeitstempel, Farbe, URL, Bild einfügen…',
		tryLabel: 'Beispiel',
		plainText: 'Klartext',
		noMatchHint: 'Keine genaue Übereinstimmung – unten ein Text-Tool wählen oder alles durchsuchen',
		runHint: 'ausführen',
		...
		chainNew: 'Neu',
		chainSteps: 'Schritte',
		chainMoreRecipes: 'Weitere Rezepte',
	...
	tl: {
		...
		qrdResult: 'Dekodierter Inhalt',
		qrdNone: 'Kein QR-Code gefunden — verwende ein schärferes Bild, schneide näher am Code zu und lass den weißen Rand stehen',
		qrdOpen: 'Link öffnen',
		qrdWifiSsid: 'Netzwerk (SSID)',
		qrdWifiPass: 'Passwort',
		qrdWifiSec: 'Sicherheit',
		qrdWifiHidden: 'Verstecktes Netzwerk',
		qrdNote: 'Das Scannen findet vollständig in deinem Browser statt — weder das Bild noch das Kamerabild noch der Inhalt des Codes werden hochgeladen.',
		qrdCamera: 'Mit Kamera scannen',
		qrdCameraStop: 'Kamera stoppen',
		qrdCameraErr: 'Kamera nicht verfügbar — prüfe die Browser-Berechtigung oder nutze stattdessen ein Bild',
		rxPattern: 'Muster',
		rxTest: 'Testtext',
	...
	tools: {
		...
		'qr-code-decoder': {
			...
			description: 'QR-Codes aus Bildern oder per Kamera auslesen — URLs, WLAN und Text, komplett offline'
		},
		'json-to-yaml': {
