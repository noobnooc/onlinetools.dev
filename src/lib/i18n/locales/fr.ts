...
const fr: Messages = {
	...
	tl: {
		...
		qrdNote: 'Le scan se fait entièrement dans votre navigateur — ni l’image ni le contenu du code ne sont envoyés.',
		rxPattern: 'Motif',
	...
	tools: {
		...
		'qr-code-decoder': {
			...
			description: 'Lisez un QR code depuis une image — URL, WiFi et texte, sans envoi'
		},
		'json-to-yaml': {
