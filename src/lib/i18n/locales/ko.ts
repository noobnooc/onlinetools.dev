...
const ko: Messages = {
	...
	ui: {
		...
		aboutH1: '계산기가 몰래 본부에 연락해선 안 됩니다.',
		aboutLead:
		...
		aboutS1Head: '모든 것이 당신의 기기에서 실행됩니다',
		aboutS1Body:
		...
		aboutS4Head: '빠르고, 방해하지 않습니다',
		aboutS4Body:
			'스플래시 화면도, “약관에 동의”도, 당신과 작업 사이를 가로막는 모달도 없습니다. {kbd}를 누르면 어떤 도구로든 건너뛰고, 무엇이든 붙여 넣으면 알맞은 도구가 스스로 떠오르며, 모든 결과는 클립보드까지 한 번의 키입니다. 철저히 키보드 우선입니다.',
		aboutVerifyIntro:
		...
		aboutBugLine:
			'혹시 어떤 도구가 당신의 데이터를 가서는 안 될 곳으로 보낸다면, 그건 비즈니스 모델이 아니라 버그입니다——{issue} 주시면 고치겠습니다.',
		aboutBugLink: 'issue를 남겨',
