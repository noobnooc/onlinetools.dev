	...
	{#if color && contrast}
		<div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
			...
			<div class="rounded-lg border border-line bg-surface px-4 py-3">
				<span class="mb-2 block text-[11px] tracking-wide text-dim uppercase">RGB channels</span>
				<div class="space-y-2">
			...
			<!-- Contrast check -->
			<div class="rounded-lg border border-line bg-surface px-4 py-3">
				<span class="mb-2 block text-[11px] tracking-wide text-dim uppercase">Text contrast (WCAG)</span>
