<script lang="ts">
	...
	/**
	 * Compact GitHub button that sits beside the language and theme toggles —
	 * a persistent "the source is right here" signal. lucide dropped its brand
	 * marks, so the GitHub logo is inlined as an SVG and tinted with the theme.
	 */
</script>
