...
<div class="flex min-h-screen bg-canvas lg:h-screen lg:overflow-hidden">
	...
	<div class="flex min-w-0 flex-1 flex-col lg:min-h-0 lg:p-3">
		...
		<div
			class="flex min-h-0 flex-1 flex-col overflow-hidden bg-surface lg:rounded-2xl lg:border lg:border-line lg:shadow-[0_1px_2px_rgba(16,24,40,0.04),0_8px_24px_-12px_rgba(16,24,40,0.12)]"
		>
